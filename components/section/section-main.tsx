...
import { SessionTypeSelect } from '../shared/item-select/session-type-select';
import { DaySelect } from '../shared/item-select/days-select';
...
export function SectionMain({
    ...
    const { staff, isLoading: isLoadingSession } = useSession();
    ...
    const {
        ...
        queryFn : () => fetchApi<OfferSection[]>({ url: `${KEY_QUERYS.SECTIONS}/faculty/${staff?.facultyId}` }),
